# collect.py — Los Angeles Rams collector
...
# - Rams-only filtering (stricter for Google/Bing)
# - HARDENED: final-link host allowlist so the dropdown can’t bloat
...
# ---------------- Rams-specific filters ----------------
KEYWORDS_ANY = [
    "los angeles rams", "la rams", "rams",
    "sean mcvay", "les snead", "matthew stafford",
    "cooper kupp", "puka nacua", "aaron donald", "byron young",
    "sofi stadium", "rams vs", "rams at", "vs rams", "at rams",
]
FOOTBALL_HINTS = [
...
EXCLUDE_ANY = [
    # other LA teams / noise
    "la dodgers", "lakers", "clippers", "angels", "kings",
    "college", "high school", "ramblers", "colorado state rams",
]

AGGREGATORS = {"news.google.com", "www.bing.com", "bing.com"}

# ---- HARD allowlist: only these domains may appear in the feed ----
ALLOWED_SOURCES = {
    # Official / team / league
    "therams.com", "nfl.com",
    # Local/beat & trusted outlets
    "turfshowtimes.com",                  # SB Nation
    "theramswire.usatoday.com",           # USA Today team site
    "latimes.com", "ocregister.com",      # SoCal beats
    # Major national sports
    "espn.com", "cbssports.com", "foxsports.com", "si.com",
    "theathletic.com", "apnews.com", "sportingnews.com",
    "yahoo.com", "sports.yahoo.com", "bleacherreport.com",
}

# Pretty labels for dropdown
DOMAIN_LABELS = {
    "therams.com": "Los Angeles Rams (Official)",
    "nfl.com": "NFL.com",
    "turfshowtimes.com": "Turf Show Times",
    "theramswire.usatoday.com": "Rams Wire",
...
def collect():
    ...
    for feed in FEEDS:
        ...
        for e in parsed.entries:
            ...
            # Extract outlet suffix; cleaned title for display/dedupe
            ...
            # HARDEN: final host must be on the allowlist
